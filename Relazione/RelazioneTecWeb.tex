	...
	\section{Implementazione}
		...
		\subsection{Linguaggi}
			...
			\subsubsection{JavaScript}
				...
				Infine JavaScript è stato ritenuto utile per nelle pagine di takeaway, carrello e pagamento per spostare i  prodotti selezionati da una pagina ad un altra o per disabilitare degli input in base alle selezioni dell'utente.
