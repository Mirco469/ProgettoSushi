	...
	\section{Progettazione}
		...
		\subsection{Accessibilità}
			...
			\subsubsection{Altri elementi di accessibilità}
				%colore link visitati, link circolari, accessibilità mobile, breadcrumb, uso di standard web (w3c validated), carousel non atuomatico, torna su, evitato font scorrevoli/lampeggianti/troppo elaborati/testo sbarrato, immagine logo come sfondo perchè non costrituisce parte del contenuto, menu ad hamburger cmq visibile dagli screen reader perchè non è stato usato display:none, suggerimento screen reader (ora si trova nel paragrafo attributi html)
